...
public class Vehicle implements Comparable<Vehicle> {
    ...
    private double unit_distance_cost;
    ...
    public double getUnit_distance_cost() {
        return unit_distance_cost;
    }

    public void setUnit_distance_cost(double unit_distance_cost) {
